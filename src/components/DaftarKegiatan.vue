  ...
  <q-layout view="lHh LpR fFf">
    ...
    <q-page-container>
      ...
      <q-page v-else-if="view.view === 'villages'" padding>
        <q-list bordered>
          <q-item v-for="village in view.selectedSurvey.villages" :key="village.id" clickable
            @click="view.selectVillage(village)">
      ...
      <q-page v-else-if="view.view === 'residents'" padding>
        <q-list bordered>
          <q-item v-for="resident in view.selectedRt.residents" :key="resident.id" clickable
            @click="view.selectAssignment(resident)">
            <q-item-section>{{ resident.name }}</q-item-section>
          </q-item>
        </q-list>
        <q-page-sticky position="bottom-right" :offset="[18, 18]">
          <q-fab icon="menu" direction="up" color="blue-10" external-label>
            ...
            <q-fab-action external-label color="warning" icon="filter_alt" label="Filter by Status"
              label-position="left" />
        ...
        <q-dialog v-model="approval">
          <q-card>
            ...
            <q-card-section class="q-pt-none ">
              ...
              <q-btn style="width: 200px; margin-bottom: 20px;" color="teal block w-10" @click="simpanDanKeluar">Simpan
                dan Keluar</q-btn>
            </q-card-section>
